defmodule Misobo.RewardsTest do
  ...
  describe "rewards" do
    ...
    @valid_attrs %{
      ...
      how_to_redeem: "some how_to_redeem",
      img: "some img",
      karma: 42,
      offer_details: "some offer_details",
      people_unlocked: 42,
    ...
    @update_attrs %{
      ...
      how_to_redeem: "some updated how_to_redeem",
      img: "some updated img",
      karma: 43,
      offer_details: "some updated offer_details",
      people_unlocked: 43,
  ...
  describe "reward_codes" do
    ...
    @valid_attrs %{
      code: "some code",
      is_active: true,
      redeemed_on: ~N[2010-04-17 14:00:00],
      valid_from: ~N[2010-04-17 14:00:00],
      valid_upto: ~N[2010-04-17 14:00:00]
    }
    @update_attrs %{
      code: "some updated code",
      is_active: false,
      redeemed_on: ~N[2011-05-18 15:01:01],
      valid_from: ~N[2011-05-18 15:01:01],
      valid_upto: ~N[2011-05-18 15:01:01]
    }
    @invalid_attrs %{
      code: nil,
      is_active: nil,
    ...
    test "update_reward_code/2 with valid data updates the reward_code" do
      ...
      assert {:ok, %RewardCode{} = reward_code} =
               Rewards.update_reward_code(reward_code, @update_attrs)
